...
sint16 GetNTC_temp(uint16 ADC_val)
{
    ...
    tempVal = ((1023.0-ADC_val)/ADC_val*1.0)*10000;

    tempVal = (sint16)((3950/(long double)(298*logf(tempVal)+1205.3185))*298-273.25);
...
void main(void) {
    ...
    while (1)
    {
        ...
        for (i=1; i <= myOrders[0]; i++)
        {
            ...
            STPR_voidMoveStprStps (&MyStprs[2 +item_index], count*200 , DIR_Low);
        }
