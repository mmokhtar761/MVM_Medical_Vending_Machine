...
SOURCEFILES_QUOTED_IF_SPACED=01_APP/newmain.c "E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork/02_HAL/STPR_prog.c" 02_HAL/LCD_prog.c 03_MCAL/DIO_prog.c 03_MCAL/UART_prog.c 03_MCAL/ADC_Prog.c 03_MCAL/EXTI_prg.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/01_APP/newmain.p1 ${OBJECTDIR}/_ext/370941739/STPR_prog.p1 ${OBJECTDIR}/02_HAL/LCD_prog.p1 ${OBJECTDIR}/03_MCAL/DIO_prog.p1 ${OBJECTDIR}/03_MCAL/UART_prog.p1 ${OBJECTDIR}/03_MCAL/ADC_Prog.p1 ${OBJECTDIR}/03_MCAL/EXTI_prg.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/01_APP/newmain.p1.d ${OBJECTDIR}/_ext/370941739/STPR_prog.p1.d ${OBJECTDIR}/02_HAL/LCD_prog.p1.d ${OBJECTDIR}/03_MCAL/DIO_prog.p1.d ${OBJECTDIR}/03_MCAL/UART_prog.p1.d ${OBJECTDIR}/03_MCAL/ADC_Prog.p1.d ${OBJECTDIR}/03_MCAL/EXTI_prg.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/01_APP/newmain.p1 ${OBJECTDIR}/_ext/370941739/STPR_prog.p1 ${OBJECTDIR}/02_HAL/LCD_prog.p1 ${OBJECTDIR}/03_MCAL/DIO_prog.p1 ${OBJECTDIR}/03_MCAL/UART_prog.p1 ${OBJECTDIR}/03_MCAL/ADC_Prog.p1 ${OBJECTDIR}/03_MCAL/EXTI_prg.p1

# Source Files
SOURCEFILES=01_APP/newmain.c E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork/02_HAL/STPR_prog.c 02_HAL/LCD_prog.c 03_MCAL/DIO_prog.c 03_MCAL/UART_prog.c 03_MCAL/ADC_Prog.c 03_MCAL/EXTI_prg.c
...
${OBJECTDIR}/02_HAL/LCD_prog.p1: 02_HAL/LCD_prog.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/02_HAL" 
	@${RM} ${OBJECTDIR}/02_HAL/LCD_prog.p1.d 
	@${RM} ${OBJECTDIR}/02_HAL/LCD_prog.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"00_Lib" -I"01_APP" -I"02_HAL" -I"03_MCAL" -I"E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/02_HAL/LCD_prog.p1 02_HAL/LCD_prog.c 
	@-${MV} ${OBJECTDIR}/02_HAL/LCD_prog.d ${OBJECTDIR}/02_HAL/LCD_prog.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/02_HAL/LCD_prog.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/03_MCAL/DIO_prog.p1: 03_MCAL/DIO_prog.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/03_MCAL" 
	@${RM} ${OBJECTDIR}/03_MCAL/DIO_prog.p1.d 
	@${RM} ${OBJECTDIR}/03_MCAL/DIO_prog.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"00_Lib" -I"01_APP" -I"02_HAL" -I"03_MCAL" -I"E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/03_MCAL/DIO_prog.p1 03_MCAL/DIO_prog.c 
...
${OBJECTDIR}/03_MCAL/ADC_Prog.p1: 03_MCAL/ADC_Prog.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/03_MCAL" 
	@${RM} ${OBJECTDIR}/03_MCAL/ADC_Prog.p1.d 
	@${RM} ${OBJECTDIR}/03_MCAL/ADC_Prog.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"00_Lib" -I"01_APP" -I"02_HAL" -I"03_MCAL" -I"E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/03_MCAL/ADC_Prog.p1 03_MCAL/ADC_Prog.c 
	@-${MV} ${OBJECTDIR}/03_MCAL/ADC_Prog.d ${OBJECTDIR}/03_MCAL/ADC_Prog.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/03_MCAL/ADC_Prog.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/03_MCAL/EXTI_prg.p1: 03_MCAL/EXTI_prg.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/03_MCAL" 
	@${RM} ${OBJECTDIR}/03_MCAL/EXTI_prg.p1.d 
	@${RM} ${OBJECTDIR}/03_MCAL/EXTI_prg.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"00_Lib" -I"01_APP" -I"02_HAL" -I"03_MCAL" -I"E:/05- BOSS PROJECT/Project2/MPLAB_FrameWork" -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/03_MCAL/EXTI_prg.p1 03_MCAL/EXTI_prg.c 
	@-${MV} ${OBJECTDIR}/03_MCAL/EXTI_prg.d ${OBJECTDIR}/03_MCAL/EXTI_prg.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/03_MCAL/EXTI_prg.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
