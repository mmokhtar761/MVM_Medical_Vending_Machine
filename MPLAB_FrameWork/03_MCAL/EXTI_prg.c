...
__interrupt(high_priority) void ISR1(void)      //High priority interrupt ISR
{
    ...
    if(GET_BIT(INTCON3,0)==1)                    //polling for INT1 interrupt
    { /*
       * Do something 
       */
      BIT_L(INTCON3,0);                        //clearing INT1 interrupt flag
    }
   
    
    if(GET_BIT(INTCON3,1)==1)                    //polling for INT2 interrupt
    { /*
       * Do something 
       */
     BIT_L(INTCON3,1);                        //clearing INT2 interrupt flag
    }
